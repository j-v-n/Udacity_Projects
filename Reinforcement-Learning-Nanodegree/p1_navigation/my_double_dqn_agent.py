...
class DQNAgent:
    ...
    def __init__(self, state_size, action_size, seed):
        ...
        self.local_net = DQN(state_size, action_size, seed).to(device) #creating local network
        self.target_net = DQN(state_size, action_size, seed).to(device) #creating target network
